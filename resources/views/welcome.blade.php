...
<body class="bg-white">
    <nav class="bg-white border-gray-200 shadow-md dark:bg-gray-900">
        <div class="flex flex-wrap items-center justify-between max-w-screen-md p-4 mx-auto"> 
            <h3 class="text-xl font-bold">Gallery Foto</h3>
...
<section>
    <h1 class="text-center font-hurricane text-5xl">Simpan Foto Terbaikmu</h1>
    </section>
    </body>
<!---gambar bokep ku--->
    ...
    <div class="flex justify-center gap-4">
        <div>
            <div class="filex flex flex-col gap-4">
                <div class="">
            <img src="/assets/2.jpg" alt="" class="rounded-lg">
            </div>
            <div class="">
            <img src="/assets/1231.jpg" alt="">
            </div>
            </div>
            </div>
            <div class="">
           <div><img src="/assets/bungaaa.jpg" alt="" class="rounded-lg">
        </div>
    </div>
</section>
</html>
